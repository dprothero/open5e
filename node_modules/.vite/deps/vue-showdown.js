...
var VueShowdown = defineComponent({
  ...
  setup(props, { slots }) {
    const converter = computed(() => {
      const instance = new import_showdown.default.Converter({
        extensions: props.extensions || void 0
      });
    ...
    const inputMarkdown = computed(() => {
      ...
      const slot = (_a = slots.default) == null ? void 0 : _a.call(slots)[0];
...
var VueShowdownPlugin = {
  install(app, { flavor = null, options = {} } = {}) {
    if (flavor !== null) {
      import_showdown.default.setFlavor(flavor);
    }
    Object.entries(options).forEach(([key, value]) => {
      import_showdown.default.setOption(key, value);
    });
    app.component("VueShowdown", VueShowdown);
  }
};
var export_showdown = import_showdown2.default;
export {
  VueShowdown,
  VueShowdownPlugin,
  VueShowdownPlugin as default,
  export_showdown as showdown
};
...
vue-showdown/dist/vue-showdown.esm.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=vue-showdown.js.map
